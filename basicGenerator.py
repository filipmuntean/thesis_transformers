...
def go(arg):
    ...
    # create the model
    model = basicTransformer(emb=arg.embedding_size, heads=arg.num_heads, depth=arg.depth, seq_length=arg.context, num_tokens=NUM_TOKENS, attention_type=arg.attention_type)
    if torch.cuda.is_available():
        model.cuda()
